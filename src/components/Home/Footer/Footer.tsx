...
export default function Footer() {
  ...
  return <>
    <footer className="footer footer-center p-10 bg-base-900 text-base-content">
      <aside>
        ...
        <p className="font-bold ">
          Geacord <br />{t("home.footer.text1")}
        </p>
        <p>{t("home.footer.text2")}</p>
      </aside>
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="https://github.com/thegears/geacord"><GitHub /></a>
        </div>
      </nav>
    </footer>
  </>
